...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.body.addEventListener('click', (e) => {
        ...
        if (navItem && navItem.innerText && navItem.innerText.trim().toLowerCase() === 'clientes') {
...
window.deletarCliente = async function(id) {
    ...
    const confirmacao = confirm("⚠️ ATENÇÃO: Tem certeza que deseja deletar este cliente permanentemente?");
...
if (typeof window.openClientDossier === 'undefined') {
    window.openClientDossier = function(id, nome, whatsapp, biografia) {
        ...
        if (typeof window.showToast === 'function') window.showToast(`Abrindo dossiê de ${nome}...`, false);
    };
}